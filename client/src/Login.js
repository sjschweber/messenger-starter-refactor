    ...
    <Grid container direction="row" className={classes.root}>
        <Grid item xs={5} className={classes.item}>
          <Card className={classes.card}>
            <CardMedia className={classes.media} component="img" src='/bg-img.png'/>
        ...
        <Grid item xs={7} className={classes.form}>
          <Box className={classes.createAccount}>
            <Typography color="secondary" className={classes.secondaryText}>Don't&nbsp;have&nbsp;an&nbsp;account?</Typography>
            <Button className={classes.shadowedButton} size="large" color="primary" onClick={() => history.push("/register")}>
              Create&nbsp;Account
            </Button>
          </Box>
          <Box className={classes.formInput}>
            ...
            <form onSubmit={handleLogin}>
              <Grid>
                ...
                <InputLabel className={classes.secondaryText}>Password</InputLabel>
                <FormControl margin="normal" required>
                  <TextField
                    className={classes.textField}
                    aria-label="password"
                ...
                <Grid className={classes.submit}>
                  <Button className={classes.login} type="submit" color="primary" variant="contained" size="large">
